...
from lib.cartography.graph.job import GraphJob
from lib.cartography.graph.statement import get_job_shortname
from lib.cartography.stats import get_stats_client
from lib.cartography.stats import ScopedStatsClient
...
def run_analysis_job(
    ...
    package: str = 'lib.cartography.data.jobs.analysis',
) -> None:
...
def run_cleanup_job(
    ...
    package: str = 'lib.cartography.data.jobs.cleanup',
) -> None:
    GraphJob.run_from_json(
        neo4j_session,
        read_text(
