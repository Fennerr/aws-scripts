...
class Ingestor(Elements):
    # Subclasses of this class are created as the SERVICES object in cli.py
    # - SERVICES = list(Ingestor.__subclasses__())
    # The subclass name needs to match the types specified in th RESOURCES
    # 
    ...
    def __init__(self, session, account, console,
        ...
        # Need to add it to the RESOURCES definition of AWS types, in lib.aws.resources.py
